 ...
 *
 * @par 更新历史:
 * - v2.0 (2025): 完整的基础驱动框架，支持STM32G0系列
 */
...
#include "stm32g0xx_ll_gpio.h"
    ...
    /**
     * @brief GPIO引脚编号枚举 (适配STM32G0系列)
     * @note 提供统一的GPIO引脚映射，支持STM32G0系列的所有可用引脚
     */
    typedef enum
    {
        ...
        // GPIOF端口引脚定义 (STM32G0系列部分型号有GPIOF，但通常只有少数引脚)
        YDRV_PINF0,                /*!< GPIOF引脚0 */
        YDRV_PINF1,                /*!< GPIOF引脚1 */
        YDRV_PINF2,                /*!< GPIOF引脚2 */
        YDRV_PINF3,                /*!< GPIOF引脚3 */
